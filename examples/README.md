# Dog Breeds API - Examples

This folder contains example code for using the Dog Breeds API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/dogbreeds',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/dogbreeds");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/dogbreeds](https://docs.apiverve.com/ref/dogbreeds)
